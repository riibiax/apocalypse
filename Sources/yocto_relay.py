#*********************************************************************
#*
#* $Id: yocto_relay.py 8329 2012-10-18 08:30:16Z martinm $
#*
...
class YRelay(YFunction):
    ...
    def get_state(self):
        ...
        @return either YRelay.STATE_A or YRelay.STATE_B, according to the state of the relay (A for the
    ...
    def set_state(self, newval):
        ...
        @param newval : either YRelay.STATE_A or YRelay.STATE_B, according to the state of the relay (A for
    ...
    def get_output(self):
        ...
        @return either YRelay.OUTPUT_OFF or YRelay.OUTPUT_ON, according to the output state of the relay,
    ...
    def get_delayedPulseTimer(self):
        ...
        On failure, throws an exception or returns YRelay.DELAYEDPULSETIMER_INVALID.
        """
        if self._cacheExpiration <= YAPI.GetTickCount():
            if YAPI.YISERR(self.load(YAPI.DefaultCacheValidity)):
