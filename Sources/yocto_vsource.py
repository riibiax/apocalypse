#*********************************************************************
#*
#* $Id: yocto_vsource.py 7545 2012-09-05 16:01:27Z seb $
#*
...
class YVSource(YFunction):
    ...
    def get_failure(self):
        """
        Return true if the  module is in failure mode. More information can be obtained by testing
        ...
        @return either YVSource.FAILURE_FALSE or YVSource.FAILURE_TRUE
    ...
    def get_overHeat(self):
        ...
        @return either YVSource.OVERHEAT_FALSE or YVSource.OVERHEAT_TRUE
    ...
    def get_overCurrent(self):
        ...
        @return either YVSource.OVERCURRENT_FALSE or YVSource.OVERCURRENT_TRUE
    ...
    def get_overLoad(self):
        ...
        @return either YVSource.OVERLOAD_FALSE or YVSource.OVERLOAD_TRUE
    ...
    def get_regulationFailure(self):
        ...
        @return either YVSource.REGULATIONFAILURE_FALSE or YVSource.REGULATIONFAILURE_TRUE
    ...
    def get_extPowerFailure(self):
        ...
        @return either YVSource.EXTPOWERFAILURE_FALSE or YVSource.EXTPOWERFAILURE_TRUE
